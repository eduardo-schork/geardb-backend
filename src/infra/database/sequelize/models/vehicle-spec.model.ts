...
export default function defineVehicleSpecModel(sequelize: Sequelize) {
    return sequelize.define<Model<TVehicleSpecEntity>>(
        'VehicleSpecModel',
        {
            ...
            maxSpeedKmH: { type: DataTypes.INTEGER, allowNull: true },
            ...
            lengthMM: { type: DataTypes.INTEGER, allowNull: true },
            wheelbaseMM: { type: DataTypes.INTEGER, allowNull: true },
            heightMM: { type: DataTypes.INTEGER, allowNull: true },
            widthMM: { type: DataTypes.INTEGER, allowNull: true },
            curbWeightKg: { type: DataTypes.INTEGER, allowNull: true },
            trunkCapacityL: { type: DataTypes.INTEGER, allowNull: true },
            tankCapacityL: { type: DataTypes.INTEGER, allowNull: true },
            payloadKg: { type: DataTypes.INTEGER, allowNull: true },
